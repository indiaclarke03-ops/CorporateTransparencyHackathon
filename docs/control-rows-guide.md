...
4. **China countermeasure listings (team decision needed).** The Tradeverifyd screen matched Northrop Grumman Systems Corporation (confirmed) and DZYNE Technologies (0.927, unconfirmed) to China's Anti-Foreign Sanctions Law countermeasure lists, which target US defense companies over arms sales to Taiwan. These listings are not evidence of wrongdoing. Proposed rule: the "Listed party" signal counts US, UN, EU and UK lists only, and adversary-state countermeasure lists are shown as context, never scored. Under that rule both rows stay controls and become useful hard negatives.
