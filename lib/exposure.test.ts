...
describe('computeFlows', () => {
  it('caps a payment at the payer inflow', () => {
    const { flows, inflow } = computeFlows({
      award: { id: 'A', agency: 'x', recipientId: 'p', obligated: 100, date: null, url: null, certainty: 'documented', demo: true },
      recipientId: 'p',
      subawards: [{ id: 's', primeAwardId: 'A', payerId: 'p', payeeId: 'a', amount: 60, date: null, url: null, certainty: 'documented', demo: true }],
      purchases: [{ id: 'q', payerId: 'a', payeeId: 'b', amount: 90, date: null, hsCode: null, certainty: 'estimated', demo: true }],
    })
  ...
  it('ignores flows that never connect to the award, including cycles', () => {
    const { flows } = computeFlows({
      ...
      subawards: [],
      purchases: [
        { id: 'x', payerId: 'a', payeeId: 'b', amount: 5, date: null, hsCode: null, certainty: 'estimated', demo: true },
        { id: 'y', payerId: 'b', payeeId: 'a', amount: 5, date: null, hsCode: null, certainty: 'estimated', demo: true },
      ],
    })
...
describe('computeFlows cumulative cap', () => {
  it('never lets a payer pass on more than it received in total', () => {
    const { flows, inflow } = computeFlows({
      ...
      recipientId: 'p',
      subawards: [
        { id: 's1', primeAwardId: 'A', payerId: 'p', payeeId: 'a', amount: 70, date: '2024-01-01', url: null, certainty: 'documented', demo: true },
        { id: 's2', primeAwardId: 'A', payerId: 'p', payeeId: 'b', amount: 70, date: '2024-02-01', url: null, certainty: 'documented', demo: true },
      ],
      purchases: [],
    })
...
describe('demo case', () => {
  it('caps the Alexsong purchase at the subawardee inflow', () => {
    ...
    expect(s.observedFlows).toBe(1_200_000 + 850_000 + 300_000 + 410_000 + 850_000)
  })
