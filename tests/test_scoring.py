...
def test_serniya_investigation_score():
    serniya_input = ScoringInput(
        ...
        sayari_data=SayariPassThrough(
            ...
            closed=True,
            degree=5,
            edge_counts={"has_shareholder": 4, "associated_with": 2},
            shares=[100.0],
            possibly_same_as=["serniya_engineering_llc"],
            match_keys=["ru_inn_7701234567"],
        ),
...
def test_palantir_control_score():
    palantir_input = ScoringInput(
        ...
        sayari_data=SayariPassThrough(
            ...
            closed=False,
            degree=12,
            edge_counts={"parent_of": 8, "subsidiary_of": 0},
            shares=[],
            possibly_same_as=[],
            match_keys=["us_sam_cage_1abc2"],
        ),
        tradeverifyd_score=0.0,
